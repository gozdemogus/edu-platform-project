...
namespace BaseIdentity.DataAccessLayer.Migrations
{
    ...
    [Migration("20230106183455_mig_cart3")]
    partial class mig_cart3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseIdentity.EntityLayer.Concrete.CourseCart", b =>
                {
            ...
            modelBuilder.Entity("CartCourse", b =>
                {
                    b.HasOne("BaseIdentity.EntityLayer.Concrete.Cart", null)
                        .WithMany()
                        .HasForeignKey("CartsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BaseIdentity.EntityLayer.Concrete.Course", null)
                        .WithMany()
